...
//    })];
    ...
    //self.backgroundColor=[UIColor colorWithRed:116/255.0 green:116/255.0 blue:116/255.0 alpha:0.5];
    
    //self.backgroundColor=[UIColor whiteColor];
    
    [self addSubview:({
        self.mainImage.frame = CGRectMake(margin, CGRectGetMaxY(self.tipLabel.frame), self.width-margin*2, imageHeight);
...
- (WMZSlider *)slider{
    if (!_slider) {
        ...
        //[_slider trackRectForBounds:CGRectMake(0, 0, 40, 40)];
    }
    return _slider;
}
